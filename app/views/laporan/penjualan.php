...
<div class="app-card p-6 app-reveal">
    ...
    <form method="GET" class="mb-6 rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50/95 to-white/95 p-4 sm:p-5 sticky top-20 z-20 backdrop-blur shadow-sm">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex items-end">
                <button type="button" class="w-full rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-2.5 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-100 flex items-center justify-center gap-2" onclick="downloadPenjualanExcel()">
